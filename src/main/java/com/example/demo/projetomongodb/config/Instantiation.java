package com.example.demo.projetomongodb.config;
...
import com.example.demo.projetomongodb.dto.AuthorDTO;
import com.example.demo.projetomongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// a classe post vai deixa os usuarios como copia e não referencia nesse caso
		//Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para sao paulo", maria);
		//Post post2 = new Post(null, sdf.parse("23/07/2020"), "Bom dia", "Acordei feliz hoje",maria);
		
		// nesse caso esta como copia mas usando DTO - data transfer object
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para sao paulo", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/07/2020"), "Bom dia", "Acordei feliz hoje", new AuthorDTO(maria));
		...
		//nesse caso está como referencia
